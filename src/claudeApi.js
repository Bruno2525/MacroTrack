...
export async function explainGoals({ peso, altura, idade, sexo, atividade, objetivo, calorias, proteina, carbo, gordura }) {
  const prompt = `O usuário tem os seguintes dados: peso ${peso}kg, altura ${altura}cm, idade ${idade} anos, sexo ${sexo}, nível de atividade: ${atividade}, objetivo: ${objetivo}.

As metas calculadas foram: ${calorias} kcal, ${proteina}g de proteína, ${carbo}g de carboidrato, ${gordura}g de gordura.

Explique em 3-4 linhas, de forma simples e motivadora em português, por que essas metas fazem sentido para o perfil do usuário.`
